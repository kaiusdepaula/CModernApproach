/*
 * Ch07 Pr14 | C Programming, A Modern Approach
 *
 ...
 * of x. For greater accuracy, your program should use variables of type
 * double rather than float. Have the program terminate when the absolute
 * value of the difference between the old value of y and the new value of y
 * is less than the product of .00001 and y. Hint: Call the fabs function to
 * find the absolute value of a double. (You'll need to include the math.h
